...
public class TokenUtils {
    ...
    private static final Long MILLIS_MINUTE_TEN = 80 * 60 * 1000L;
...
//        String token = attributes.getRequest().getHeader("User-Agent").toLowerCase();
        ...
        long millisMinuteTen;
        //pc端失效时间为120分钟，验证令牌有效期，相差不足80分钟，自动刷新缓存
        millisMinuteTen = MILLIS_MINUTE_TEN;
    ...
    public void refreshToken(LoginUser loginUser) {
        ...
        redisCache.setCacheObject(userKey, JSONObject.toJSONString(loginUser), expireTime, TimeUnit.MINUTES);
    }
